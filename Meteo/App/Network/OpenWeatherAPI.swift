...
typealias OpenWeatherAPIsProvider = OWWeatherProvider & OWGeocoding
...
final actor OpenWeatherAPI: OpenWeatherAPIWeatherProviding {
    ...
    private let openWeather: OpenWeatherAPIsProvider

    init(openWeather: OpenWeatherAPIsProvider = OpenWeather(token: "4b6d48939ebb16871c7b44244512c341")) {
