...
protocol WeatherContainerViewModelType: NSObjectProtocol {
  ...
  func reloadWeatherSummary(locAPI: LocationProviding, weatherAPI: OpenWeatherAPIWeatherProviding, force: Bool) async throws -> WeatherWrapper?
  func reloadForecast(locAPI: LocationProviding, weatherAPI: OpenWeatherAPIWeatherProviding, force: Bool) async throws -> WeatherForecast?
}
...
final class WeatherContainerViewModel: NSObject, WeatherContainerViewModelType, ObservableObject {
  ...
  private func currentLocation(_ locAPI: LocationProviding = LocationAPI.shared) async throws -> Location {
  ...
  func reloadWeatherSummary(locAPI: LocationProviding = LocationAPI.shared,
